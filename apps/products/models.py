...
from apps.core.models import TimeStampMixin, GENDER_CHOICES
...
class Category(TimeStampMixin):
    ...
    slug = models.SlugField(unique=True, verbose_name='Слаг')
    logo = models.ImageField(upload_to='products', unique=True, verbose_name='Логотип')
...
class Image(TimeStampMixin):
    ...
    path = models.ImageField(upload_to='products', unique=True, verbose_name='Название')
