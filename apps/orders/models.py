...
from apps.products.models import ProductDetails
...
class Order(TimeStampMixin):
    user = models.ForeignKey('users.User', on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Пользователь')
