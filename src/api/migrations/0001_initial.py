# Generated by Django 4.1 on 2022-10-09 13:59
...
class Migration(migrations.Migration):
    ...
    replaces = [('api', '0001_initial'), ('api', '0002_initial'), ('api', '0003_rename_address_order_user_address')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='child_categories', to='api.category', verbose_name='Родительская категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.useraddress', verbose_name='Адрес доставки')),
        ...
        migrations.AddConstraint(
            model_name='coupon',
            constraint=models.CheckConstraint(check=models.Q(('use_limit__isnull', True), ('use_limit__gte', models.F('used_amount')), _connector='OR'), name='api_coupon_used_amount_less_then_use_limit_or_equal'),
        ),
