# Generated by Django 4.1 on 2022-10-09 16:28
...
class Migration(migrations.Migration):
    ...
    replaces = [('product', '0001_initial'), ('product', '0002_initial')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.product', verbose_name='Товар')),
                ('product_material', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='product.productmaterial', verbose_name='Материал')),
            ],
        ),
        migrations.AddField(
            model_name='productmaterial',
            name='products',
            field=models.ManyToManyField(related_name='materials', through='product.ProductMaterialProduct', to='product.product', verbose_name='Товары'),
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
                ...
                ('product_color', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='product.productcolor', verbose_name='Цвет')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_color', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='product.productcolor', verbose_name='Цвет товара')),
                ('product_size', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='product.productsize', verbose_name='Размер товара')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='default_color',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='product.productcolor', verbose_name='Цвет по умолчанию'),
        ),
        migrations.AddField(
            model_name='product',
            name='manufacturer',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('part__range', (1, 100))), name='product_productmaterialproduct_part_between_1_and_100'),
        ),
        migrations.AlterUniqueTogether(
            name='productmaterialproduct',
