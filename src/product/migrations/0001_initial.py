    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_color', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='product.color', verbose_name='Цвет товара')),
                ('product_size', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='product.size', verbose_name='Размер товара')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.product', verbose_name='Товар')),
                ('product_material', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='product.material', verbose_name='Материал')),
            ],
        ),
        migrations.AddField(
            model_name='material',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_color', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='product.color', verbose_name='Цвет')),
            ],
            options={
