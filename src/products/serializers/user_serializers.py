...
class ProductListSerializer(serializers.ModelSerializer):  # TODO: find better way to extract images for product
    ...
    def get_images(self, product):
        return product.images.filter(color=product.default_color).values('path')
...
class ProductDetailsSerializer(serializers.ModelSerializer):
    ...
    in_stock = serializers.BooleanField(source='quantity', read_only=True)

    class Meta:
        model = ProductDetails
        fields = ('slug', 'color', 'size', 'in_stock')
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Review
        fields = ('created_at', 'user', 'product', 'rating', 'text')
